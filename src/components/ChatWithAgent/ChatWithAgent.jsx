...
//                     <div className="form-group">
//                         <label>Name Below:</label>
//                         <input type="text" className="form-control" placeholder="Enter a message" onChange={e => onTextChange(e)} value={state ? state.name : ""}/>
//                     </div>
//                 </div>
//                 <div className="row">
//                     <div className="form-group">
//                         <label>Message Below:</label>
//                         <input type="text" className="form-control" placeholder="Enter a message" onChange={e => onTextChange(e)} value={state ? state.message : ""}/>
//                     </div>
//                 </div>
//                 <button>Send Message</button>
//             </form>
